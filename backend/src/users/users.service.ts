...
export interface UserProfile {
  ...
  /**
   * Whether the account's plan allows it. Sent alongside [adBlockEnabled] so the
   * client can say *why* filtering is off rather than just that it is. Always
   * true today — see `entitledToAdBlocking`.
   */
